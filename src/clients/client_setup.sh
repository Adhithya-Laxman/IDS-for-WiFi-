...
cat <<EOL > "$ENV_FILE"
export GLOBAL_PARAMS_PATH="$HOME/IDS-for-WiFi-/src/trained models/GLOBAL_dbn_rbm_model.pth"
export CLIENT_PARAMS_PATH="$HOME/IDS-for-WiFi-/src/trained models/$HOSTNAME.pth"
