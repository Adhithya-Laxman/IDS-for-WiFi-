...
if __name__ == '__main__':
    ...
    dataset = pd.read_csv('/home/adminroot/Desktop/2105001/IDS/IDS-for-WiFi-/datasets/processed/Filtered_dataset.csv').astype('float32')
    ...
    save_path = '/home/adminroot/Desktop/2105001/IDS/IDS-for-WiFi-/src/trained models/dbn_rbm_model_client_two_attacks.pth'
    torch.save({
